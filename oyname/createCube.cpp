...
//    Engine::PositionEntity(light, -10.0f, 0.0f, 0.0f);
//
...
//    Engine::PositionEntity(cube2, 5.0f, 0.0f, 0.0f);
//
//    LPMESH cube3;
//    CreateCube(&cube3);
//    Engine::PositionEntity(cube3, -5.0f, 0.0f, 0.0f);
//
...
//        Engine::TurnEntity(cube2, 0.5f, 0.0f, 0.0f);
//        Engine::TurnEntity(cube3, 0.0f, 0.5f, 0.0f);
//
//        Engine::RenderWorld();
//
//        Engine::Flip();
